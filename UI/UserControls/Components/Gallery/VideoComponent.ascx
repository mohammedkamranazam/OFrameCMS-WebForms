<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VideoComponent.ascx.cs" Inherits="OWDARO.UI.UserControls.Components.Gallery.VideoComponent" %>
...
<div class="VideoDiv">
    ...
    <div class="Description">
        <div class="Info">
            ...
            <span class="Share">
                <asp:HyperLink runat="server" ID="VideoDownloadLink" CssClass="btn"><i class="icon-arrow-down"></i>Download</asp:HyperLink>
            </span>
        </div>
