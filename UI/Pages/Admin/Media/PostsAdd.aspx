<%@ Page Async="true" Title="" Language="C#" AutoEventWireup="true" CodeBehind="PostsAdd.aspx.cs"
    Inherits="ProjectJKL.UI.Pages.Admin.Media.PostsAdd" %>
            ...
            <asp:UpdatePanel runat="server" ID="UpdatePanel1" ClientIDMode="Static">
                <ContentTemplate>
                    ...
                    <div class="grid3">
                        ...
                        <OWD:ListPopUpComponent runat="server" ID="PostsListPopUpComponent1" Width="500px" Height="500px" Text="Select Parent Post" Enabled="false" />
                        ...
                        <OWD:CheckBoxAdv runat="server" ID="HideCheckBox" LabelText="Hide" SmallLabelText="show/hide the post" HelpLabelText="select to hide this post" />
