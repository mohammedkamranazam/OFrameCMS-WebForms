<%@ Page Async="true" Title="" Language="C#" AutoEventWireup="true" CodeBehind="ProjectCategoriesManage.aspx.cs" Inherits="ProjectJKL.UI.Pages.Admin.Media.ProjectCategoriesManage" %>
...
<asp:content id="Content2" contentplaceholderid="ContentPlaceHolder1" runat="server">
    <div class="onecolumn">
        <div class="header">
            <span><span class="ico color window"></span>Edit Project Category</span>
        </div>
        <div class="Clear">
        </div>
        <div class="uibutton-toolbar btn-group">
                ...
                <asp:HyperLink ID="HyperLink2" runat="server" CssClass="btn btn-success" NavigateUrl="~/UI/Pages/Admin/Media/ProjectCategoriesAdd.aspx">
