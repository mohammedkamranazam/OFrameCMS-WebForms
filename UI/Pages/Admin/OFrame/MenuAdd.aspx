<%@ Page Async="true" Title="" Language="C#" AutoEventWireup="true" CodeBehind="MenuAdd.aspx.cs" Inherits="ProjectJKL.UI.Pages.Admin.OFrame.MenuAdd" %>
...
<asp:content id="Content2" contentplaceholderid="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" ClientIDMode="Static">
        <ContentTemplate>
            <div class="onecolumn">
                <div class="header">
                    <span><span class="ico color window"></span>Add Menu</span>
                </div>
                <div class="Clear">
                </div>
                <div class="uibutton-toolbar btn-group">
                        <asp:HyperLink ID="HyperLink1" runat="server" CssClass="btn" NavigateUrl="~/UI/Pages/Admin/OFrame/MenuList.aspx">
                            <i class="icon-list-ul"></i> List Menu Items
                        </asp:HyperLink>
                    </div>
                <div class="content">
