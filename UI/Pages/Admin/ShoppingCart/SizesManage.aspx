<%@ Page Async="true" Title="" Language="C#" AutoEventWireup="true" CodeBehind="SizesManage.aspx.cs"
    Inherits="ProjectJKL.UI.Pages.Admin.ShoppingCart.SizesManage" %>
...
<asp:content id="Content2" contentplaceholderid="ContentPlaceHolder1" runat="server">
    <div class="onecolumn">
        <div class="header">
            <span><span class="ico color window"></span>Manage Size</span>
        </div>
        <div class="Clear">
        </div>
        <div class="content">
            ...
            <asp:UpdatePanel runat="server" ID="UpdatePanel1" ClientIDMode="Static">
                <ContentTemplate>
                    ...
                    <OWD:DropDownListAdv runat="server" ID="CategoriesDropDownList" LabelText="Category"
                        SmallLabelText="category to which this size belongs" InitialValue="-1"
                    ...
                    <OWD:DropDownListAdv runat="server" ID="SubCategoriesDropDownList" LabelText="Sub Category"
                        SmallLabelText="sub category to which this size belongs" InitialValue="-1"
