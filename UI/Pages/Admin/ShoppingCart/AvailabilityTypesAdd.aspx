<%@ Page Async="true" Title="" Language="C#"
    AutoEventWireup="true" CodeBehind="AvailabilityTypesAdd.aspx.cs" Inherits="ProjectJKL.UI.Pages.Admin.ShoppingCart.AvailabilityTypesAdd" %>
...
<asp:content id="Content2" contentplaceholderid="ContentPlaceHolder1" runat="server">
    <div class="onecolumn">
        <div class="header">
            <span><span class="ico color window"></span>Add New Availability Type</span>
        </div>
        <div class="Clear">
        </div>
        <div class="content">
