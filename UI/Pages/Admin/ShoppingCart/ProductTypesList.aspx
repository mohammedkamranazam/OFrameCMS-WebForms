<%@ Page Async="true" Title="" Language="C#" AutoEventWireup="true" CodeBehind="ProductTypesList.aspx.cs"
    Inherits="ProjectJKL.UI.Pages.Admin.ShoppingCart.ProductTypesList" %>
...
<asp:content id="Content2" contentplaceholderid="ContentPlaceHolder1" runat="server">
    <div class="onecolumn">
        <div class="header">
            <span><span class="ico color window"></span>Product Types List</span>
        </div>
        <div class="Clear">
        </div>
            ...
            <ContentTemplate>
                <div class="content">
                    <div class="uibutton-toolbar btn-group">
                        <asp:HyperLink ID="HyperLink1" runat="server" CssClass="btn btn-success" NavigateUrl="~/UI/Pages/Admin/ShoppingCart/ProductTypesAdd.aspx">
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <div class="btn-group" style="margin: 5px;">
                                        <asp:HyperLink ID="HyperLink2" runat="server" CssClass="btn btn-mini" NavigateUrl='<%#String.Format("ProductTypesManage.aspx?ProductTypeID={0}", Eval("ProductTypeID")) %>'>
                                            <i class="icon-cog"></i> Manage Type
                                        </asp:HyperLink>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
    ...
    <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=ShoppingCartEntities"
        DefaultContainerName="ShoppingCartEntities" EnableFlattening="False" EntitySetName="SC_ProductTypes" AutoGenerateWhereClause="True">
        <WhereParameters>
