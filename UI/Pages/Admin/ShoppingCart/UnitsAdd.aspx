<%@ Page Title="" Language="C#"
    AutoEventWireup="true" CodeBehind="UnitsAdd.aspx.cs" Inherits="ProjectJKL.UI.Pages.Admin.ShoppingCart.UnitsAdd" Async="true" %>
...
<asp:content id="Content2" contentplaceholderid="ContentPlaceHolder1" runat="server">
    <div class="onecolumn">
        <div class="header">
            <span><span class="ico color window"></span>Add New Unit</span>
        </div>
        <div class="Clear">
        </div>
        <div class="content">
            ...
            <asp:UpdatePanel runat="server" ID="UpdatePanel1" ClientIDMode="Static">
                <ContentTemplate>
                    ...
                    <OWD:DropDownListAdv runat="server" ID="CategoriesDropDownList" LabelText="Category"
                        SmallLabelText="category to which this unit belongs" Visible="false" InitialValue="-1"
                    ...
                    <OWD:DropDownListAdv runat="server" ID="SubCategoriesDropDownList" LabelText="Sub Category"
                        SmallLabelText="sub category to which this unit belongs" Visible="false" InitialValue="-1"
