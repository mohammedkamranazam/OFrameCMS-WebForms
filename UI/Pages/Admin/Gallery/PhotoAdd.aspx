<%@ Page Async="true" Title="" Language="C#"
    AutoEventWireup="true" CodeBehind="PhotoAdd.aspx.cs" Inherits="ProjectJKL.UI.Pages.Admin.Gallery.PhotoAdd" %>
...
<asp:content id="Content2" contentplaceholderid="ContentPlaceHolder1" runat="server">
    <div class="onecolumn">
        <div class="header">
            <span><span class="ico color window"></span>Add Photo</span>
        </div>
        <div class="Clear">
        </div>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" ClientIDMode="Static">
                <ContentTemplate>
                    ...
                    <div class="grid3">
                        ...
                        <OWD:TextBoxAdv MaxLength="250" TextMode="MultiLine" runat="server" ID="DescriptionEditor" LabelText="Description" SmallLabelText="enter a rich text description for photo" />
