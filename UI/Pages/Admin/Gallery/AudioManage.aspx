<%@ Page Async="true" Title="" Language="C#" AutoEventWireup="true"
    CodeBehind="AudioManage.aspx.cs" Inherits="ProjectJKL.UI.Pages.Admin.Gallery.AudioManage" %>
...
<asp:content id="Content2" contentplaceholderid="ContentPlaceHolder1" runat="server">
    <div class="onecolumn">
        <div class="header">
            <span><span class="ico color window"></span>Manage Audio</span>
        </div>
        <div class="Clear">
        </div>
        <div class="uibutton-toolbar btn-group">
                        ...
                        <asp:HyperLink ID="HyperLink2" runat="server" CssClass="btn btn-success" NavigateUrl="~/UI/Pages/Admin/Gallery/AudioAdd.aspx">
                ...
                <ContentTemplate>
                    ...
                    <div class="grid3">
                       ...
                       <owd:AudioCategoriesSelectComponent runat="server" id="AudioCategoriesSelectComponent1" />
                        <OWD:DropDownListAdv runat="server" ID="AudioSetDropDownList" LabelText="Set" SmallLabelText="set to which the audio belongs" />
