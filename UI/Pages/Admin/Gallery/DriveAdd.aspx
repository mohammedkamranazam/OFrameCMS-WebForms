<%@ Page Async="true" Title="" Language="C#"
    AutoEventWireup="true" CodeBehind="DriveAdd.aspx.cs" Inherits="ProjectJKL.UI.Pages.Admin.Gallery.DriveAdd" %>
...
<asp:content id="Content2" contentplaceholderid="ContentPlaceHolder1" runat="server">
    <div class="onecolumn">
        <div class="header">
            <span><span class="ico color window"></span>Add Drive</span>
        </div>
        <div class="Clear">
        </div>
        <div class="uibutton-toolbar btn-group">
                        <asp:HyperLink ID="HyperLink1" runat="server" CssClass="btn" NavigateUrl="~/UI/Pages/Admin/Gallery/DriveList.aspx">
                            <i class="icon-list-ul"></i> List Drives
                        </asp:HyperLink>
                    </div>
        <div class="content">
            <asp:UpdatePanel runat="server" ID="UpdatePanel1" ClientIDMode="Static">
                <ContentTemplate>
                    ...
                    <div class="grid3">
                        ...
                        <OWD:TextBoxAdv MaxLength="250" TextMode="MultiLine" runat="server" ID="DescriptionEditor" LabelText="Description" SmallLabelText="enter the description for drive" />
