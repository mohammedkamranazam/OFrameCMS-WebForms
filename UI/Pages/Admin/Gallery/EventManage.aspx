<%@ Page Async="true" Title="" Language="C#"
    AutoEventWireup="true" CodeBehind="EventManage.aspx.cs" Inherits="ProjectJKL.UI.Pages.Admin.Gallery.EventManage" %>
...
<asp:content id="Content2" contentplaceholderid="ContentPlaceHolder1" runat="server">
    <div class="onecolumn">
        <div class="header">
            <span><span class="ico color window"></span>Manage Event</span>
        </div>
        <div class="Clear">
        </div>
        <div class="uibutton-toolbar btn-group">
                        <asp:HyperLink ID="HyperLink1" runat="server" CssClass="btn btn-primary" NavigateUrl="~/UI/Pages/Admin/Gallery/EventList.aspx">
                    <i class="icon-arrow-left"></i> Go Back To Events List
                        </asp:HyperLink>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" ClientIDMode="Static">
                <ContentTemplate>
                    ...
                    <div class="grid3">
                        ...
                        <OWD:DropDownListAdv runat="server" ID="EventTypeDropDownList" LabelText="Event Type" SmallLabelText="the type of event it will be" InitialValue="-1" RequiredFieldErrorMessage="please select and event type" AutoPostBack="true" OnChange="return OnChange(this);" />
                        ...
                        <OWD:CheckBoxAdv runat="server" ID="HideCheckBox" LabelText="Hide" SmallLabelText="show/hide the events" HelpLabelText="check this to hide the event" />
