<%@ Page Async="true" Title="" Language="C#" AutoEventWireup="true"
    CodeBehind="AudioSetAdd.aspx.cs" Inherits="ProjectJKL.UI.Pages.Admin.Gallery.AudioSetAdd" %>
...
<asp:content id="Content2" contentplaceholderid="ContentPlaceHolder1" runat="server">
    <div class="onecolumn">
        <div class="header">
            <span><span class="ico color window"></span>Add New Audio Set</span>
        </div>
        <div class="Clear">
        </div>
        ...
        <div class="content">
            <asp:UpdatePanel runat="server" ID="UpdatePanel1" ClientIDMode="Static">
                <ContentTemplate>
                    ...
                    <OWD:TextBoxAdv runat="server" ID="TagsTextBox" LabelText="Tags" SmallLabelText="comma separated tags separated" MaxLength="250" FilterMode="InvalidChars" InvalidChars=" " />
