...
{
    public partial class AudioCategories : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                OWDARO.Util.Utilities.SetPageCache(OWDARO.Settings.PageCacheHelper.GetCache("AudioCategoriesPage"));
        ...
        private async Task LoadData()
        {
            ...
            {
                var tags = await (from set in context.GY_Audios
